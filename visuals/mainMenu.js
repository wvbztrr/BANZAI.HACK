...
watermark.innerHTML = `<span style="text-shadow: -1px 0.5px 0 rgb(255, 255, 255), -2px 0px rgb(255, 0, 0)e;">B</span> <span style="color:red; padding-left:2px; font-family: Garamond, serif; font-size:10px">${ver}</span>`;
...
Object.assign(dropdownMenu.style, {
    ...
    borderRadius: '10px', color: 'white', fontSize: '13px', fontFamily: 'Brush Script MT, cursive',
...
dropdownMenu.innerHTML = `
    <style>
        input[type="checkbox"] {appearance: none; width: 15px; height: 15px; background-color:rgb(59, 58, 58);
        border: 1px solid #acacac; border-radius: 3px; margin-right: 5px; cursor: pointer;}
        input[type="checkbox"]:checked {background-color:rgb(138, 11, 11); border-color:rgb(184, 15, 15);}
        input[type="text"], input[type="number"], input[type="range"] {width: calc(100% - 10px); border: 1px solidrgb(52, 52, 52); 
        color: white; accent-color:rgb(138, 11, 11); background-color:rgb(138, 11, 11); padding: 3px; border-radius: 3px; background: none;}
        label {display: flex; align-items: center; color:rgb(59, 58, 58); padding-top: 3px;}
    </style>
`;
